...
// Name-list formatting and the completion-tools nudge live in ./tool-names.js, which imports
// nothing from the agent layer so provider middleware can share them.
