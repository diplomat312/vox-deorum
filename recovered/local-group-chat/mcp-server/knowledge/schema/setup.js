 ...
 */
import { MaxMajorCivs } from './base.js';
import { createPublicKnowledgeTable, createTimedKnowledgeTable, createTimedKnowledgeIndexes, createPublicKnowledgeIndexes, createMutableKnowledgeTable, createMutableKnowledgeIndexes } from './table-utils.js';
/**
 ...
 */
export async function setupKnowledgeDatabase(db) {
    ...
    await db.schema
        ...
        .ifNotExists()
        .execute();
    // GlobalMessages table (TimedKnowledge implementation)
    // World-channel messages are visible to every player: one feed per game, ordered by ID.
