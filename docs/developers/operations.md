...
```text
npx --yes codex-openai-proxy@0.1.0-rc.17 serve --root C:\absolute\temporary\codex-root --port 8787 --log-level info --login device-code --request-timeout 300000ms --shutdown-timeout 10000ms
```
